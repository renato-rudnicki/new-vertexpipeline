...
class vertex_ai_pipeline:
    def __init__(self,
                 ...
                 PROJECT_ID: str = "prj-n-mlmachine-learning-cjqb",
                 ...
                 DATAFLOW_SA: str = "dataflow-sa@prj-n-mlmachine-learning-cjqb.iam.gserviceaccount.com",
                 ):
        ...
        self.Image = "us-central1-docker.pkg.dev/prj-c-mlartifacts-ru5k/c-publish-artifacts/vertexpipeline:v2"
    ...
    def execute(self):
        pipeline = aiplatform.PipelineJob(
            ...
            encryption_spec_key_name='projects/prj-n-kms-ljby/locations/us-central1/keyRings/sample-keyring/cryptoKeys/prj-n-mlmachine-learning',
            parameter_values={
...
if __name__ == "__main__":
    pipeline = vertex_ai_pipeline(
        ...
        PROD_PROJECT_ID="prj-p-mlmachine-learning-o4ne", \
        REGION="us-central1", \
        ...
        DATAFLOW_SUBNET="https://www.googleapis.com/compute/v1/projects/prj-n-shared-restricted-w2yi/regions/us-central1/subnetworks/sb-n-shared-restricted-us-central1", \
        JOB_NAME="census-ingest", \
        # Replace with the compute default service account of your non-prod project
        SERVICE_ACCOUNT="245359292187-compute@developer.gserviceaccount.com", \
        # Replace with the compute default service account of your prod project
        PROD_SERVICE_ACCOUNT="350128353792-compute@developer.gserviceaccount.com",
        # replace with dataflow sa from non-prod
        DATAFLOW_SA="dataflow-sa@prj-n-mlmachine-learning-cjqb.iam.gserviceaccount.com",
    )
